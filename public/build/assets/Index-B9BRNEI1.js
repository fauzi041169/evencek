import{j as e}from"./chart-9VqTYBMJ.js";import{u as B,r as d,H as C,L as u,e as w}from"./react-DEt7ljYx.js";import{W as _}from"./WebLayout-BelGNQsx.js";import{f as $}from"./vendor-Cu6_dTYL.js";import{i as A}from"./id-G9WQtbLj.js";import"./useTranslation-CfgWZPo8.js";import"./app-CxDgdaFE.js";import"./sweetalert2-BQxta0Da.js";import"./Alerts-B7mBt3yB.js";import"./circle-check-big-lfDE7JNy.js";import"./createLucideIcon-BbE30CY5.js";import"./circle-alert-cniyCs9D.js";import"./x-ByqvNtGB.js";import"./Modal-CklLeOhV.js";import"./transition-UOH9VA1b.js";import"./open-closed-B_JslzQP.js";import"./dialog-_VAkKw_U.js";import"./use-tab-direction-B_cII4LP.js";import"./FloatingAI-BHJ1T_bP.js";import"./user-Cggnlcdf.js";import"./loader-circle-ZnpdRduj.js";const N=({end:c,duration:g=2e3})=>{const[o,m]=d.useState(0),l=d.useRef(null);return d.useEffect(()=>{const i=new IntersectionObserver(p=>{if(p[0].isIntersecting){const h=parseInt(c,10);let s=null;const x=n=>{s||(s=n);const b=Math.min((n-s)/g,1);m(Math.floor(b*h)),b<1&&requestAnimationFrame(x)};requestAnimationFrame(x),i.disconnect()}},{threshold:.5});return l.current&&i.observe(l.current),()=>i.disconnect()},[c,g]),e.jsx("span",{ref:l,children:o})},k=({children:c,className:g="",direction:o="up"})=>{const m=d.useRef(null),[l,i]=d.useState(!1);d.useEffect(()=>{const h=new IntersectionObserver(([s])=>{s.isIntersecting&&(i(!0),h.disconnect())},{threshold:.1});return m.current&&h.observe(m.current),()=>h.disconnect()},[]);let p="reveal";return o==="left"&&(p="reveal-left"),o==="right"&&(p="reveal-right"),o==="pop"&&(p="reveal-pop"),e.jsx("div",{ref:m,className:`${p} ${l?"show":""} ${g}`,children:c})};function Z({featuredNews:c,allNews:g,totalNews:o,categories:m,latestNews:l}){const i=l||g,{url:p,props:h}=B(),{appSettings:s}=h,x=s?.hero_animation_style||"circles",n=(t,a)=>{if(!t)return`rgba(124, 58, 237, ${a})`;let r;return/^#([A-Fa-f0-9]{3}){1,2}$/.test(t)?(r=t.substring(1).split(""),r.length==3&&(r=[r[0],r[0],r[1],r[1],r[2],r[2]]),r="0x"+r.join(""),"rgba("+[r>>16&255,r>>8&255,r&255].join(",")+","+a+")"):t},[b,M]=d.useState(new URLSearchParams(window.location.search).get("query")||""),[v,j]=d.useState(!1);d.useEffect(()=>{const t=localStorage.getItem("editMode")==="true";j(t);const a=()=>{const r=localStorage.getItem("editMode")==="true";j(r)};return window.addEventListener("editModeChanged",a),()=>window.removeEventListener("editModeChanged",a)},[]);const S=t=>{t.preventDefault(),w.get(route("news.search"),{query:b},{preserveState:!0})},f=t=>t?$(new Date(t),"d MMMM yyyy",{locale:A}):"-",y=t=>{if(!t)return"/assets/images/hero/defoult.webp";if(t.startsWith("http"))return t;let a=t.startsWith("/")?t.substring(1):t;return a.startsWith("storage/storage/")&&(a=a.substring(8)),a.startsWith("storage/")||a.startsWith("assets/")?"/"+a:`/storage/${a}`};return e.jsxs(_,{hasHeaderSpacer:!1,fluid:!0,noPadding:!0,children:[e.jsx(C,{title:"Berita & Artikel"}),e.jsx("style",{children:`
