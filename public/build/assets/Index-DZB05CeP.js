import{u as _,r as c,j as e,H as C,L as u,a as N}from"./app-CVy04fGo.js";import{W as $}from"./WebLayout-CmXV_2L4.js";import{f as B,i as I}from"./id-BZEFkztJ.js";import"./Alerts-Cq_5K6we.js";import"./circle-check-big-Df_pvPlX.js";import"./createLucideIcon-Cio9L2FH.js";import"./circle-alert-A2j51F_b.js";import"./x-BhVWqmK9.js";import"./useTranslation-BkscareZ.js";const w=({end:d,duration:g=2e3})=>{const[l,m]=c.useState(0),o=c.useRef(null);return c.useEffect(()=>{const i=new IntersectionObserver(h=>{if(h[0].isIntersecting){const p=parseInt(d,10);let s=null;const x=n=>{s||(s=n);const f=Math.min((n-s)/g,1);m(Math.floor(f*p)),f<1&&requestAnimationFrame(x)};requestAnimationFrame(x),i.disconnect()}},{threshold:.5});return o.current&&i.observe(o.current),()=>i.disconnect()},[d,g]),e.jsx("span",{ref:o,children:l})},k=({children:d,className:g="",direction:l="up"})=>{const m=c.useRef(null),[o,i]=c.useState(!1);c.useEffect(()=>{const p=new IntersectionObserver(([s])=>{s.isIntersecting&&(i(!0),p.disconnect())},{threshold:.1});return m.current&&p.observe(m.current),()=>p.disconnect()},[]);let h="reveal";return l==="left"&&(h="reveal-left"),l==="right"&&(h="reveal-right"),l==="pop"&&(h="reveal-pop"),e.jsx("div",{ref:m,className:`${h} ${o?"show":""} ${g}`,children:d})};function P({featuredNews:d,allNews:g,totalNews:l,categories:m,latestNews:o}){const i=o||g,{url:h,props:p}=_(),{appSettings:s}=p,x=s?.hero_animation_style||"circles",n=(t,a)=>{if(!t)return`rgba(124, 58, 237, ${a})`;let r;return/^#([A-Fa-f0-9]{3}){1,2}$/.test(t)?(r=t.substring(1).split(""),r.length==3&&(r=[r[0],r[0],r[1],r[1],r[2],r[2]]),r="0x"+r.join(""),"rgba("+[r>>16&255,r>>8&255,r&255].join(",")+","+a+")"):t},[f,M]=c.useState(new URLSearchParams(window.location.search).get("query")||""),[v,j]=c.useState(!1);c.useEffect(()=>{const t=localStorage.getItem("editMode")==="true";j(t);const a=()=>{const r=localStorage.getItem("editMode")==="true";j(r)};return window.addEventListener("editModeChanged",a),()=>window.removeEventListener("editModeChanged",a)},[]);const S=t=>{t.preventDefault(),N.get(route("news.search"),{query:f},{preserveState:!0})},b=t=>t?B(new Date(t),"d MMMM yyyy",{locale:I}):"-",y=t=>{if(!t)return"/assets/images/hero/defoult.webp";if(t.startsWith("http"))return t;let a=t.startsWith("/")?t.substring(1):t;return a.startsWith("storage/storage/")&&(a=a.substring(8)),a.startsWith("storage/")||a.startsWith("assets/")?"/"+a:`/storage/${a}`};return e.jsxs($,{hasHeaderSpacer:!1,children:[e.jsx(C,{title:"Berita & Artikel"}),e.jsx("style",{children:`
