import{u as b,j as e,H as v}from"./app-k2IysBLQ.js";import{W as k}from"./WebLayout-B5F-d0ps.js";import"./useTranslation-yOoqUglO.js";import"./Alerts-DSV9JjWQ.js";import"./circle-check-big-H7IurqXv.js";import"./createLucideIcon-Ce82S9Su.js";import"./circle-alert-B5jeJRRu.js";import"./x-BbxZY-rx.js";import"./Modal-BeKOrI5Y.js";import"./transition-DZZtqHxs.js";import"./open-closed-CmYd3P7z.js";import"./dialog-Tv8IfquG.js";import"./use-tab-direction-F4q-Feuf.js";import"./FloatingAI-v2P6V14P.js";import"./user-Djw32Uaj.js";import"./loader-circle-BLIzwo1H.js";function w({title:d,description:i,heroAnim:x,shape:t="waves",children:n}){const{appSettings:h}=b().props,s=x||h?.hero_animation_style||"circles",l=h?.hero_background_1||null,f=r=>r?r.startsWith("http")?r:`/storage/${r}`:null;return e.jsxs("section",{className:"page-hero relative overflow-hidden",children:[e.jsx("style",{children:`
                .page-hero {
                    position: relative;
                    min-height: 450px;
                    display: flex;
