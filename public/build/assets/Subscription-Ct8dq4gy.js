import{u as b,j as e,H as v}from"./app-DEb6lxWF.js";import{W as k}from"./WebLayout-DgmDqE91.js";import"./useTranslation-Crk_2geT.js";import"./Alerts-B_xr1uUI.js";import"./circle-check-big-BywUdqYB.js";import"./createLucideIcon-CY_zfxSO.js";import"./circle-alert-BrfCpu-f.js";import"./x-43ToYLbq.js";import"./Modal-g4xiNnuS.js";import"./transition-CVKNxm9O.js";import"./open-closed-Dwao2kIe.js";import"./dialog-DOrwZHje.js";import"./use-tab-direction-Dcwcpgis.js";function w({title:d,description:i,heroAnim:x,shape:t="waves",children:n}){const{appSettings:h}=b().props,s=x||h?.hero_animation_style||"circles",l=h?.hero_background_1||null,f=r=>r?r.startsWith("http")?r:`/storage/${r}`:null;return e.jsxs("section",{className:"page-hero relative overflow-hidden",children:[e.jsx("style",{children:`
                .page-hero {
                    position: relative;
                    min-height: 450px;
                    display: flex;
