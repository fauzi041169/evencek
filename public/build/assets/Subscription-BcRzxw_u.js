import{u as b,j as e,H as v}from"./app-D475r-Eu.js";function k({title:m,description:i,heroAnim:x,shape:t="waves",children:n}){const{appSettings:h}=b().props,s=x||h?.hero_animation_style||"circles",l=h?.hero_background_1||null,f=r=>r?r.startsWith("http")?r:`/storage/${r}`:null;return e.jsxs("section",{className:"page-hero relative overflow-hidden",children:[e.jsx("style",{children:`
                .page-hero {
                    position: relative;
                    min-height: 450px;
                    display: flex;
