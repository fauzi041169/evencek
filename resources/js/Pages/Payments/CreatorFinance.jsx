        ...
        <MainLayout title="Keuangan Creator">
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-2 sm:py-8 px-4">
                <div className="max-w-7xl mx-auto">
                    {/* Header Banner */}
                    <div className="mb-6 bg-gradient-to-br from-indigo-900 via-purple-800 to-indigo-900 rounded-2xl p-6 sm:p-8 text-white shadow-lg relative overflow-hidden ring-1 ring-white/10">
                        {/* Decorative elements */}
                        <div className="absolute top-0 right-0 -mt-10 -mr-10 w-48 h-48 bg-purple-500/20 rounded-full blur-3xl"></div>
                        <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-48 h-48 bg-indigo-500/20 rounded-full blur-3xl"></div>
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="p-2.5 bg-white/10 rounded-xl backdrop-blur-md shadow-inner border border-white/20">
                                        <i className="fas fa-wallet text-xl text-purple-200"></i>
                                    </div>
                                    <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white drop-shadow-md">
                                        Keuangan Creator
                                    </h1>
                                </div>
                                <p className="text-indigo-100 text-sm sm:text-base max-w-lg font-medium leading-relaxed drop-shadow-sm opacity-90">
                                    Kelola pendapatan dan pantau arus kas kegiatan Anda dengan mudah dan transparan.
                                </p>
                            </div>

                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-8 bg-black/20 p-5 rounded-xl backdrop-blur-md border border-white/10 shadow-lg">
                                <div>
                                    <p className="text-indigo-200 text-[10px] sm:text-xs font-bold mb-0.5 uppercase tracking-wider">Saldo Bisa Ditarik</p>
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-white text-indigo-900 text-sm font-bold rounded-lg hover:bg-indigo-50 transition-all flex items-center justify-center gap-2 shadow-xl active:scale-95 group"
                                >
                                    <i className="fas fa-money-bill-transfer text-base text-indigo-700"></i>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all group">
                            <div className="flex items-start justify-between mb-3">
                                <div className="p-2 bg-emerald-50 rounded-lg group-hover:bg-emerald-100 transition-colors">
                                    <i className="fas fa-arrow-trend-up text-lg text-emerald-600"></i>
                                </div>
                                <span className="text-[10px] font-semibold px-1.5 py-0.5 bg-gray-50 text-gray-500 rounded-md">
                                    Semua Waktu
                                </span>
                            </div>
                            <div className="text-gray-500 text-xs font-medium mb-0.5">Total Pendapatan</div>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all group">
                            <div className="flex items-start justify-between mb-3">
                                <div className="p-2 bg-blue-50 rounded-lg group-hover:bg-blue-100 transition-colors">
                                    <i className="fas fa-hand-holding-dollar text-lg text-blue-600"></i>
                                </div>
                                <span className="text-[10px] font-semibold px-1.5 py-0.5 bg-blue-50 text-blue-600 rounded-md">
                                    Manual
                                </span>
                            </div>
                            <div className="text-gray-500 text-xs font-medium mb-0.5">Pendapatan Manual</div>
                            <div className="text-lg font-bold text-gray-900 truncate">
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all group">
                            <div className="flex items-start justify-between mb-3">
                                <div className="p-2 bg-indigo-50 rounded-lg group-hover:bg-indigo-100 transition-colors">
                                    <i className="fas fa-credit-card text-lg text-indigo-600"></i>
                                </div>
                                <span className="text-[10px] font-semibold px-1.5 py-0.5 bg-indigo-50 text-indigo-600 rounded-md">
                                    Gateway
                                </span>
                            </div>
                            <div className="text-gray-500 text-xs font-medium mb-0.5">Pendapatan Gateway</div>
                            <div className="text-lg font-bold text-gray-900 truncate">
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all group">
                            <div className="flex items-start justify-between mb-3">
                                <div className="p-2 bg-rose-50 rounded-lg group-hover:bg-rose-100 transition-colors">
                                    <i className="fas fa-arrow-trend-down text-lg text-rose-600"></i>
                                </div>
                                <span className="text-[10px] font-semibold px-1.5 py-0.5 bg-gray-50 text-gray-500 rounded-md">
                                    Terproses
                                </span>
                            </div>
                            <div className="text-gray-500 text-xs font-medium mb-0.5">Total Penarikan</div>
                            <div className="text-lg font-bold text-gray-900 truncate">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-indigo-800 to-purple-800 px-6 py-3 flex justify-between items-center">
                                            ...
                                            <tr key={index} className="hover:bg-gray-50/80 transition-colors group">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-center">
                                                    <button
                                                        ...
                                                        className={`inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm group border ${entry.category === 'income'
                                                    ...
                                                    >
                                                        <i className={`fas fa-eye mr-2 ${entry.category === 'income'
                            ...
                            <div className="bg-white px-6 py-6">
                                <div className="grid grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <span className={`inline-flex px-2 py-1 mt-1 text-xs font-bold rounded-full ${['paid', 'approved', 'completed'].includes(selectedTransaction.status) ? 'bg-green-100 text-green-800' :
