...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\LogNewsRequests::class,
            \App\Http\Middleware\LocaleMiddleware::class,
            \App\Http\Middleware\MaintenanceMode::class, // Added globally to web group
    ...
    protected $middlewareAliases = [
        ...
        'record.pageview' => \App\Http\Middleware\RecordPageView::class,
